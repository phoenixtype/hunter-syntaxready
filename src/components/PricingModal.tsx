                ...
                <div className="grid md:grid-cols-2">
                    ...
                    <div className="p-8 space-y-6 bg-background/50">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /> 20 Applications / Month</li>
                            <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /> Basic Resume Tailoring</li>
                            <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500" /> Daily Job Feed</li>
                        </ul>
                    ...
                    <div className="p-8 space-y-6 bg-gradient-to-br from-primary/10 to-primary/5 relative overflow-hidden">
                        ...
                        <div className="space-y-2 relative z-10">
                            <h3 className="text-xl font-bold flex items-center gap-2">
                                Hunter Pro <Sparkles className="w-4 h-4 text-yellow-400" />
                            </h3>
                        ...
                        <ul className="space-y-3 text-sm relative z-10">
                            <li className="flex items-center gap-2"><Zap className="w-4 h-4 text-yellow-500" /> Unlimited Applications</li>
                            <li className="flex items-center gap-2"><Zap className="w-4 h-4 text-yellow-500" /> Deep Intelligence Briefings</li>
                            <li className="flex items-center gap-2"><Zap className="w-4 h-4 text-yellow-500" /> Negotiation Coach Agent</li>
