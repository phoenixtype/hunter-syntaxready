    ...
    const handleSave = async () => {
        ...
        try {
            await savePreferences(user.id, {
                ...
                safe_mode: preferences?.safe_mode ?? true,
                require_sponsorship: preferences?.require_sponsorship ?? false,
                has_clearance: preferences?.has_clearance ?? false,
                notice_period_days: preferences?.notice_period_days ?? 14,
