...
CREATE TABLE IF NOT EXISTS "public"."application_history" (
    ...
    "notes" "text",
    "metadata" "jsonb" DEFAULT '{}'::"jsonb",
    CONSTRAINT "application_history_status_check" CHECK (("status" = ANY (ARRAY['applied'::"text", 'pending'::"text", 'failed'::"text", 'interview'::"text", 'rejected'::"text", 'offer'::"text"])))
);
...
CREATE POLICY "Edge functions can insert job listings" ON "public"."job_listings" FOR INSERT WITH CHECK (true);



CREATE POLICY "Edge functions can update job listings" ON "public"."job_listings" FOR UPDATE USING (true) WITH CHECK (true);



CREATE POLICY "Job listings are publicly readable" ON "public"."job_listings" FOR SELECT USING (true);



CREATE POLICY "Service role can manage rate limit buckets" ON "public"."rate_limit_buckets" USING (true) WITH CHECK (true);



CREATE POLICY "Users can delete their own applications" ON "public"."application_history" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete their own candidate profile" ON "public"."candidate_profiles" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete their own feedback" ON "public"."feedback_actions" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete their own logs" ON "public"."agent_activity_logs" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can delete their own metrics" ON "public"."compliance_metrics" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can delete their own weights" ON "public"."learning_weights" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert own applications" ON "public"."application_history" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert own feedback" ON "public"."feedback_actions" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert own metrics" ON "public"."compliance_metrics" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can insert own weights" ON "public"."learning_weights" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert their own logs" ON "public"."agent_activity_logs" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can manage their candidate profile" ON "public"."candidate_profiles" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage their feedback" ON "public"."feedback_actions" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage their preferences" ON "public"."user_preferences" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage their weights" ON "public"."learning_weights" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update own applications" ON "public"."application_history" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update own metrics" ON "public"."compliance_metrics" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update own weights" ON "public"."learning_weights" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own feedback" ON "public"."feedback_actions" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update their own logs" ON "public"."agent_activity_logs" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view only their own logs" ON "public"."agent_activity_logs" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view own applications" ON "public"."application_history" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view own feedback" ON "public"."feedback_actions" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view own metrics" ON "public"."compliance_metrics" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view own weights" ON "public"."learning_weights" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their application history" ON "public"."application_history" USING (("auth"."uid"() = "user_id"));
...
CREATE TRIGGER on_auth_user_created_mirror AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user_mirror();
...
with check (((bucket_id = 'resumes'::text) AND (auth.uid() = owner)));
  ...
  create policy "Authenticated users can view their own resumes"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
